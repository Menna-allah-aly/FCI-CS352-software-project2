...
public class Entitytest {
	...
	UserEntity user = new UserEntity("samah", "samah", "123");
	...
	public void sendrequest() {
		boolean b = U.sendrequest("sara@yahoo.com");
	...
	@Test
	public void Searching_OnPeople_who_AddMe() {
		...
		ArrayList<String> m = U.Searching_OnPeople_who_AddMe();
	...
	public void createTimelinePost() {
		try {
			boolean b = U.createTimelinePost("Timeline post", "shoes", "hello",
					"happy", "public");
			Assert.assertEquals(true, b);
		} catch (Exception E) {
			E.printStackTrace();
